...
_service = function($rootScope, $http) {
  ...
  self.disableRedirectBooking = function() {
    return localStorage.setItem("disableRedirectBooking", true);
  };
  self.resetRedirectBooking = function() {
    return localStorage.removeItem("disableRedirectBooking");
  };
  self.isDisableRedirectBooking = function() {
    return localStorage.getItem("disableRedirectBooking") || false;
  };
